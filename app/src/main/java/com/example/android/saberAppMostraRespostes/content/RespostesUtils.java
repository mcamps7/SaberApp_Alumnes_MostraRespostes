...
public class RespostesUtils {
    ...
    public static class Pregunta {
        ...
        private Pregunta(String content, String details, String url) {
    ...
    private static Pregunta createPreguntaAtPosition(int position) {
        ...
        switch (position) {
            case 0:
                ...
                newUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/e/ea/Van_Gogh_-_Starry_Night_-_Google_Art_Project.jpg/1920px-Van_Gogh_-_Starry_Night_-_Google_Art_Project.jpg";
                break;
            case 1:
        ...
        return new Pregunta(newTitle, newDetail, newUrl);
    }
}
